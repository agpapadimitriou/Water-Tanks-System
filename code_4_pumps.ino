...
const int Pub_1_pin = 2;
const int Pub_2_pin = 3;
const int Pub_3_pin = 5;
const int Pub_4_pin = 6;
...
void writeDepth(int Depth){
  ...
  int distanceFromSurface = 100;//depth_measure();
